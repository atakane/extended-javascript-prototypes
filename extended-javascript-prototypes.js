...
// Returns n characters of the string from right
...
if (!String.prototype.withSuffix) {
    String.prototype.withSuffix = function(n) {
        if (!isNaN(n)) {
            var suffix = "th";
...
/*
C# String.Format() equivalent in JavaScript
Replaces {0},{1}..{n} with args[0],args[1]...args[n]
